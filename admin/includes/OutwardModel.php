    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>OutWard Product</b></h4>
            </div>
            ...
            <div class="modal-footer">
                    <input type="button" onclick="onOutward()" value="ADD" title="" id="outwardbutton" class='btn btn-success btn-sm  btn-flat'>
            </div>
        </div>
    </div>
</div>
...
<!-- Edit -->
<div class="modal fade" id="editOutWard">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                          ...
                          ?>
                            <label for="productdate" class="">Date</label>
                            <input type="date" value="<?php echo date('Y-m-d'); ?>" class="" id="Editproductdate" name="Editproductdate"  required>
            ...
            <div class="modal-footer">
                    <input type="button" onclick="onEditOutWard()" value="Update" title="" id="Editoutwardbutton" class='btn btn-success btn-sm  btn-flat'>
            </div>
        </div>
    </div>
</div>