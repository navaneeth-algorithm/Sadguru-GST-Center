    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="report_add.php" enctype="multipart/form-data">
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST"  action="report_edit.php" enctype="multipart/form-data">
		...
		<div class="form-group">
		<label for="reportfile" class="col-sm-1 control-label">File</label>
		  <input type=text id="edit_reportfile" disabled />
                  <div class="col-sm-5">
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="report_delete.php">
                <input type="hidden" class="catid" name="id">
