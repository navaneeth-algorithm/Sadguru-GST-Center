        ...
        <div class="w3-col s6" style="margin-left:180px">
            ...
            <div class="w3-light-gray" >
                <div id='installmentCalculator' class="w3-panel w3-container w3-padding  w3-light-gray w3-text-dark-gray w3-center">
                    <h4 class="w3-center">Sadhguru Dashama Cash Certificate Calculator</h4>
...
function amort(balance, interestRate, terms)
{
    ...
    var result = "<span class= w3-justify w3-margin'>Investment amount: " + balance.toFixed(2) +  "</span>" + 
	...
	result += "<table id='tableStart' class='w3-table-all w3-centered w3-hoverable'><tr><th>Maturity Amount:</th>";
